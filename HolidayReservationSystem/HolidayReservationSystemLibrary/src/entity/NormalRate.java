...
public class NormalRate extends RoomRate implements Serializable {
    ...
    public NormalRate(Date startDate, Date endDate, Long roomRateId, String rateName, BigDecimal ratePerNight, String roomStatus, RoomType roomType) {
    ...
    public String toString() {
        return "entity.NormalRate[ id=" + startDate + " ]";
    }
